...
internal sealed class OrLogicExpression : BaseLogicOperationExpression
{
    public OrLogicExpression(ILogicExpression left, ILogicExpression right) : base(left, right)
    {
    }
