...
internal sealed class EqualExpression : ComparisonExpression
{
    ...
    public override Expression Compile()
        => Expression.Call(_castMethod, Expression.MakeBinary(ExpressionType.Equal, Left.Compile(), Right.Compile()));
